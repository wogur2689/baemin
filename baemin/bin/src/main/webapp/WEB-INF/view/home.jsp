			...
			<section class="address_search">
				<div id="search_box">
					<div>
						...
						value="${BMaddress.address1}" name="address1" readonly>
						<input type="text" id="deleveryAddress2" placeholder="주소를 입력해 주세요"
						value="${BMaddress.address2}" onClick="modifyAddress()" name="address2"><br>
					</div>
